		...
		<ul class="slides-container">
			<li class="text-left">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>Welcome To <br> Jarif thai Restaurant</strong></h1>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							...
							<p class="m-b-40">jarif Kathiyawadi Restaurant is serving a Authentic Kathiyawadi Food.And Restaurant's 
<br> 
			...
			<li class="text-left">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>Welcome To <br> Yamifood with jarif</strong></h1>
	...
	<!-- Start About -->
	<div class="about-section-box" style="background:  url(1-kathiyawadi-restaurants-1-ki1aq.jpg) no-repeat bottom center;background-size: cover;padding: 50px 0px;color:white;">
		<div class="container">
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-12 text-center">
					<div class="inner-column">
						<h1>Welcome To <span>jarif Kathiyawadi Restaurant</span></h1>
						<h4 style="color:white;font-size:20px;">Little Story</h4>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 ml-auto mr-auto text-center">
					...
					<span class="lead">jarif Restaurent</span>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
						<h2>Gallery</h2>
						<p>Delicious food Pictures for jarif Restaurent Listed Here </p>
					</div>
				</div>
			</div>
